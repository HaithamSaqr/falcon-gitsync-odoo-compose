...
# ===========================================
# Falcon Git-Sync Odoo 16 Docker Compose
# Branch: 16.0
...
print_usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  $0 --destination /opt/odoo19 --port 10016 --chat 20016"
    echo "  $0 --destination /opt/odoo19 --port 10016 --chat 20016 --addons-repo git@github.com:user/addons.git --git-sync"
    echo "  $0 --destination /opt/odoo19 --port 10016 --chat 20016 --addons-repo git@github.com:user/addons.git --addons-branch 19.0 --git-sync"
}
