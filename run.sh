...
# ===========================================
# Falcon Git-Sync Odoo 14 Docker Compose
# Branch: 14.0
...
print_usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  $0 --destination /opt/odoo19 --port 10014 --chat 20014"
    echo "  $0 --destination /opt/odoo19 --port 10014 --chat 20014 --addons-repo git@github.com:user/addons.git --git-sync"
    echo "  $0 --destination /opt/odoo19 --port 10014 --chat 20014 --addons-repo git@github.com:user/addons.git --addons-branch 19.0 --git-sync"
}
