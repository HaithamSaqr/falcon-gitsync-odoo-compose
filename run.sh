...
# ===========================================
# Falcon Git-Sync Odoo 20 Docker Compose
# Branch: 20.0
...
print_usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  $0 --destination /opt/odoo19 --port 10020 --chat 20020"
    echo "  $0 --destination /opt/odoo19 --port 10020 --chat 20020 --addons-repo git@github.com:user/addons.git --git-sync"
    echo "  $0 --destination /opt/odoo19 --port 10020 --chat 20020 --addons-repo git@github.com:user/addons.git --addons-branch 19.0 --git-sync"
}
