...
# ===========================================
# Falcon Git-Sync Odoo 17 Docker Compose
# Branch: 17.0
...
print_usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  $0 --destination /opt/odoo19 --port 10017 --chat 20017"
    echo "  $0 --destination /opt/odoo19 --port 10017 --chat 20017 --addons-repo git@github.com:user/addons.git --git-sync"
    echo "  $0 --destination /opt/odoo19 --port 10017 --chat 20017 --addons-repo git@github.com:user/addons.git --addons-branch 19.0 --git-sync"
}
