...
# ===========================================
# Falcon Git-Sync Odoo 15 Docker Compose
# Branch: 15.0
...
print_usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  $0 --destination /opt/odoo19 --port 10015 --chat 20015"
    echo "  $0 --destination /opt/odoo19 --port 10015 --chat 20015 --addons-repo git@github.com:user/addons.git --git-sync"
    echo "  $0 --destination /opt/odoo19 --port 10015 --chat 20015 --addons-repo git@github.com:user/addons.git --addons-branch 19.0 --git-sync"
}
