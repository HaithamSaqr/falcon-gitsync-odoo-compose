...
# ===========================================
# Falcon Git-Sync Odoo 18 Docker Compose
# Branch: 18.0
...
print_usage() {
    ...
    echo ""
    echo "Examples:"
    echo "  $0 --destination /opt/odoo19 --port 10018 --chat 20018"
    echo "  $0 --destination /opt/odoo19 --port 10018 --chat 20018 --addons-repo git@github.com:user/addons.git --git-sync"
    echo "  $0 --destination /opt/odoo19 --port 10018 --chat 20018 --addons-repo git@github.com:user/addons.git --addons-branch 19.0 --git-sync"
}
